...
To verify go to Google, and search `what is my IP`. You will see your AWS EC2 IP, that means all your data is routed via AWS servers. <Sparkles>This means there is no more restriction on which site you can access. All sites are unlocked for you😁. Enjoy!</Sparkles>
