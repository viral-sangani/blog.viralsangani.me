...
Below is a live preview for you to test some layouts. You can use Tailwind in there too 😇
...
>
  <div className="flex items-center justify-center bg-red-500">Nav</div>
  <div className="flex items-center justify-center bg-green-500">Main</div>
  <div className="flex items-center justify-center bg-blue-500">Ads</div>
